...
<div class="am-cf admin-main">
    <jsp:include page="include/clientsidebar.jsp"/>
    <!-- content start -->
    <div class="admin-content">
        ...
        <div class="am-panel am-panel-default" style="float:right;width: 20%;">
            ...
            <ul class="am-list am-list-static am-list-striped">
                <li>在线客服
                    <button class="am-btn am-btn-xs am-btn-danger" id="tuling" data-am-button>正在飞速赶来！</button>
                </li>
            </ul>
        </div>
    </div>
...
<script>
    ...
    function sendMessage() {
        ...
        $("#tuling").text() == "已上线" ? tuling(message) : console.log("客服正在飞速赶来！");  //检测是否加入图灵机器人
